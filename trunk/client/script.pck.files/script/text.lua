...
--Loading小提示
LDG_TITLE = "^dca004Подсказка: ^ffffff%s";
LDG_TIP = {
	"Игроки могут получить опыт даже после того, как они достигли максимального уровня.",
	"Опыт имеет и другие цели, кроме продвижения на следующий уровень.",
	"Не пытайтесь бросить вызов монстрам, которые более высокого уровня, чем вы, или вы можете умереть.",
	"Игроки мужского пола могут также использовать War Fans и Charmers.",
	"Администрация никогда не будет спрашивать у вас Ваш пароль.",
	"Никому не сообщайте информацию о вашем аккаунте ни по каким причинам.",
	"Нажмите кнопку P, чтобы открыть Крафт интерфейс.",
	"Щелкните правой кнопкой мыши на цели, чтобы напасть на нее.",
	"Shift + ПКМ на убитом монстре, чтобы забрать весь дроп автоматически.",
	"Вы можете расширить свой инветарь за итемы которые продаются в игровом магазине.",
	"Выполняйте квесты вашего уровня, за них дают больше всего награды.",
	"Ваша статистика будет расти с повышением уровня персонажа, и вашего ранга.",
	"С элитных монстров, награда выше.",
	"Звезды над головой монстра показывают повышенную сложность.",
	"После достижения 40 уровня, вы можете присоединиться к одной из трех сторон: Ву, Вей, или Шу.",
	"Используйте W, S, и D, для перемещения вашего персонажа.",
	"Нажмите NumLock, чтобы персонаж двигался автоматически.",
	"Стойте лицом к врагу когда его атакуете.",
	"Игроки уровня 1-15 не могут быть атакованы другими игроками.",
	"Нажмите Alt+Z, чтобы скрыть пользовательский интерфейс.",
	"Нажмите F9, чтобы вкоючить режим камеры, который может быть использован, для скриншотов лучшего качества.",
	"Когда ваш EXP индикатор мигает, у вас достаточно опыта, чтобы увеличить уровень.",
	"Нажмите C, чтобы открыть окно символов.",
	"Вы можете повысить ваш уровень персонажа и ранг в окне персонажа.",
	"Титулы дают бонус, когда вы их устанавливаете в окне персонажа.",
	"Щелкните правой кнопкой мыши на NPC, чтобы поговорить с ними.",
	"Нажмите кнопку J, чтобы открыть Игровой Магазин.",
	"Нажмите B, чтобы открыть ваш рюкзак.",
	"Нажмите L, чтобы открыть Квестовое Окно.",
	"Нажмите Z, чтобы открыть окно Рейтинга.",
	"Нажмите T, чтобы открыть окно настройки партии.",
	"Нажмите Y, чтобы открыть окно клана.",
	"Нажмите G, чтобы открыть окно легиона.",
	"Опыт требуется для поднятия уровеня персонажа и его чина.",
	"Держите левую кнопку мыши, чтобы повернуть камеру вокруг вашего персонажа.",
	"Чем лучше материал, тем лучше броню можно изготовить.",
	"Обучение Пошиву позволяет игроку создавать броню.",
	"Обучение Кузнечеству позволяет игроку создавать оружие.",
	"Обучение приготовлению пищи позволяет игроку принимать пищу и напитки.",
	"Обучение Исцелению позволяет игроку принимать исцеляющие процедуры.",
	"Обучение Алхимия позволяет игроку принимать зелья, мгновенно восстанавливать здоровье.",
	"Пища здоровье вне боя, а иногда и некоторые баффы.",
	"Вино восстанавливает силы вне боя, а иногда и некоторые баффы.",
	"Чай восстанавливает силы вне боя, а иногда и некоторые баффы.",
	"Припарки восстановления здоровья в течение короткого времени, и может быть использован в бою.",
	"Зелья восстановливают здоровья мгновенно, и могут быть использованы в бою.",
	"Мастера Рун также продают самые разнообразные материалы.",
	"Оружие может быть повышен на более высокий уровень.",
	"Нажмите K, чтобы открыть окно навыков.",
	"Вы можете создать клан или присоединиться к клану, когда вы достигнете 15 уровня.",
	"Вы можете создать легион, когда вы получите 25-ый уровень, и если вы лидер клана.",
	"Нажмите клавишу N, чтобы открыть окно макросов с целью создания комбо-ударов.",
	"Ваш Вторичный Класс может иметь не более 25 баллов по специальности.",
	"Щелчок на пункте назначения на мини-карте или карте местности будет автоматически прокладывать маршрут.",
	"Щелкните левой кнопкой мыши на место куда вам надо перейти.",
	"Государственный войны будут доступны когда 20 Легионов достигнут 3-го уровня.",
	"Вы можете выбрать вторичный класс, когда ваш первичный класс достигает своего максимального уровня.",
	"Игроки могут получить опыт даже после того, как они достигли максимального уровня.",
	"Опыт имеет и другие цели, кроме продвижения на следующий уровень.",
	"Не пытайтесь бросить вызов монстрам, которые более высокого уровня, чем вы, или вы можете умереть.",
	"Игроки мужского пола могут также использовать War Fans и Charmers.",
	...
	"Государственный войны будут доступны когда 20 Легионов достигнут 3-го уровня.",
	"Вы можете выбрать вторичный класс, когда ваш первичный класс достигает своего максимального уровня.",
	"Ищите Кузнеца Pang в провинции Хэбэй, чтобы изучить основы Кузнечества.",
	"Ищите Портной Nie в провинции Хэбэй, чтобы изучить основы Пошива.",
	"Ищите шеф-повара Пан в провинции Хэбэй, чтобы изучить основы приготовления пищи.",
	"Ищите Чен Му в провинции Хэбэй, чтобы изучить основы Собирательства.",
	"Ищите Кузнеца Pang в провинции Хэбэй, чтобы изучить основы Кузнечества.",
	"Ищите Портной Nie в провинции Хэбэй, чтобы изучить основы Пошива.",
	"Ищите шеф-повара Пан в провинции Хэбэй, чтобы изучить основы приготовления пищи.",
	"Ищите Чен Му в провинции Хэбэй, чтобы изучить основы Собирательства.",
	"Ищите Чжао Линь в Liangzhou учиться основам чар.",
	"Ищите Лу Nusheng в Liangzhou учиться основам алхимии.",
	"Ищите Чжао Линь в Liangzhou учиться основам чар.",
	"Ищите Лу Nusheng в Liangzhou учиться основам алхимии.",
	"Ищите Ху Longluo в Liangzhou учиться основам Укрощение.",
	"Ищите Ху Longluo в Liangzhou учиться основам Укрощение.",
	"Ищите Кузнеца Pang в провинции Хэбэй, чтобы изучить основы Кузнечества.",
	"Ищите Портной Nie в провинции Хэбэй, чтобы изучить основы Пошива.",
	"Ищите шеф-повара Пан в провинции Хэбэй, чтобы изучить основы приготовления пищи.",
